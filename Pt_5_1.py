...
name = ['Гордость и предубеждение', 'Горе от ума', 'Великий Гэтсби', 'Триумфальная арка']
author = ['Джейн Остин', 'А.С.Грибоедов', 'Фрэнсис Скотт Фицджеральд', 'Эрих Мария Ремарк']
